import { a0 as head, V as attr_class, a1 as ensure_array_like, W as attr, a2 as clsx, X as bind_props, Y as stringify } from "../../../chunks/index2.js";
...
function _page($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    $$renderer2.push(`<h1 class="visually-hidden svelte-115oxdy">Sverdle</h1> <form method="post" action="?/enter" class="svelte-115oxdy"><a class="how-to-play svelte-115oxdy" href="/sverdle/how-to-play">How to play</a> <div${attr_class("grid svelte-115oxdy", void 0, { "playing": !won, "bad-guess": form?.badGuess })}><!--[-->`);
